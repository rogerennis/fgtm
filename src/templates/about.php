      ...
      <div class="wrapper">
        ...
        <div class="leadership-container">
          <article class="leadership">
            <figure><img src="<?php echo get_template_directory_uri(); ?>/img/leadership/pastor_john_&_cristine_williamson.jpg" alt="pastors John & Christine Williamson" /></figure>
            <h4>Rev. John & Cristine Williamson</h4>
          ...
          <article class="leadership">
            <figure><img src="<?php echo get_template_directory_uri(); ?>/img/leadership/pastor_brian_jag.jpg" alt="pastor Brian Jag" /></figure>
